...
```
vague-des-classify/
├── vague_descriptions_checker/         # Core agent code
...
Edit your agent logic in `vague_descriptions_checker/agent.py` and test with `make playground` - it auto-reloads on save.
